...
public class MyLinkedListTester {
	...
	public void testAddEnd()
	{
		...
		list1.add(10);
		assertEquals("AddEnd: check to see if 10 is added", (Integer)10, list1.get(3));
		try {
			shortList.add(null);
			fail("Check out null");
		}
	...
	public void testAddAtIndex()
	{
		...
		assertEquals("addatIndex: check to see if 25 is added in index 0", (Integer) 25, list1.get(2));
	...
	public void testSet()
	{
		...
		assertEquals("setatIndex: check to see if 22 is set in index 1", (Integer) 22, list1.get(1));
		try {
			list1.set(3, null);
			fail("Check out null");
		}
